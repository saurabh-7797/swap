...
async function main() {
  try {
    ...
    const vaultA = new PublicKey("5b4cFuA35kMobdKDY2GVwdehTKKWS7jUZ3nQEoqf3cCX");
    const vaultB = new PublicKey("AaEP3pseKXS34HkiWcg4Y4CvVnvBS1Uvch7SXv9LXcEx");
    ...
    // 7. Instruction data (Borsh: LegacyAddLiquidity { amount_a, amount_b })
